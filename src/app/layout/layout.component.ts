...
import { AmpTrackConfig, AmpTrackConfigService } from '@amptrack/services/config';
...
import { AMPTRACK_VERSION } from '@amptrack/version';
...
export class LayoutComponent implements OnInit, OnDestroy {
    ...
    constructor(
        ...
        private _amptrackPlatformService: AmpTrackPlatformService
    ) {}
    ...
    ngOnInit(): void {
        ...
        combineLatest([
            ...
            this._amptrackMediaWatcherService.onMediaQueryChange$([
        ...
        this._renderer2.addClass(
            this._document.body,
            this._amptrackPlatformService.osName
        );
    }
